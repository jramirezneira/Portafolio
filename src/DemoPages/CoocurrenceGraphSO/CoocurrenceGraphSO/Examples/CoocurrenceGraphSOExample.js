...
export default class CoocurrenceGraphSOExample extends React.Component<{}, {width: number, height: number}> {
...
iniciaConsulta()
{
        ...
        let filterto=this.props.selectValuesTo;
        ...
        if (filterto=="Todos")
            this.state.network.moveTo({scale:0.5, position:{x:1,y:1}});
        else
            this.state.network.moveTo({scale:0.9, position:{x:1,y:1}});
